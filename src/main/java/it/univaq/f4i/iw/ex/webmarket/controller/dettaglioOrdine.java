...
public class dettaglioOrdine extends BaseController {
    ...
    */
    ...
    private void action_rifiutaOrdine(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, TemplateManagerException, DataException {
        ...
        // Reindirizzo alla pagina ordini
        response.sendRedirect("ordini");
    }
    ...
    try {
        ...
        if (action != null) {
            if (action.equals("accettaOrdine")) {
                action_accettaOrdine(request, response);
            } else if (action.equals("rifiutaOrdine")) {
